      ...
      <a-form-model :model="formTask" :rules="rulesTask" ref="refForm">
        ...
        <a-form-model-item label="运维类型" prop="routineType">
            <a-select @change="electOptionChange" v-model="formTask.routineType" placeholder="请选择">
              ...
              <a-select-option :value="1"> 单次运维 </a-select-option>
            </a-select>
          </a-form-model-item>
          <!-- 常规运维 -->
          <div v-if="formTask.taskType === 0">
            <a-form-model-item label="运维项目" prop="routineType">
            ...
            <span @click="goPages(0)">配置运维项目</span>
          </div>
          ...
          <!-- 单次运维 -->
          <div v-if="formTask.taskType != 0">
            <a-form-model-item label="仪器选择" prop="dataSubmitType">
          ...
          <a-form-model-item label="主运维人员" prop="dataSubmitType">
            <a-select v-model="formTask.dataSubmitType" placeholder="请选择">
              <a-select-option :value="0"> 瞬时 </a-select-option>
              <a-select-option :value="1"> 分钟 </a-select-option>
            </a-select>
          </a-form-model-item>
          <a-form-model-item label="备选运维人员" prop="dataSubmitType">
            <a-select v-model="formTask.dataSubmitType" placeholder="请选择">
              <a-select-option :value="0"> 瞬时 </a-select-option>
              <a-select-option :value="1"> 分钟 </a-select-option>
            </a-select>
